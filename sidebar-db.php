...
<ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li
        ...
        <a class="nav-link collapsed" href="all-post.php" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true"
    ...
    <li
        ...
        <a class="nav-link collapsed" href="library.php" data-toggle="collapse" data-target="#collapseMedia" aria-expanded="true"
    ...
    <li
        ...
        <a class="nav-link collapsed" href="all-pages.php" data-toggle="collapse" data-target="#collapsePages" aria-expanded="true"
            aria-controls="collapsePages">
    ...
    <!-- Nav Item - Pages Collapse Menu -->
    <li class="nav-item">
        <a class="nav-link collapsed" href="all-course.php" data-toggle="collapse" data-target="#collapseCourse" aria-expanded="true"
            aria-controls="collapsePages">
    ...
    <!-- Nav Item - Pages Collapse Menu -->
    <li class="nav-item">
        <a class="nav-link collapsed" href="all-user.php" data-toggle="collapse" data-target="#collapseUsers" aria-expanded="true"
            aria-controls="collapsePages">
