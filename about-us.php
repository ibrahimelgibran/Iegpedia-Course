...
<body>
        ...
        <div class="sect-03-about-us">
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    var targetNumber3 = 6; // The target number you want to count up to
                    var currentNumber3 = 0;
                    var increment3 = 1; // You can adjust the increment value

                    var counterElement3 = document.getElementById('counter-3');
                    ...
                    var counterInterval3 = setInterval(updateCounter3, 100); // You can adjust the interval value
                });
            </script>
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    var targetNumber2 = 150; // The target number you want to count up to
                    var currentNumber2 = 0;
                    var increment2 = 1; // You can adjust the increment value

                    var counterElement2 = document.getElementById('counter-2');
                    ...
                    var counterInterval2 = setInterval(updateCounter2, 80); // You can adjust the interval value
                });
            </script>
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    var targetNumber = 4; // The target number you want to count up to
                    var currentNumber = 0;
                    var increment = 1; // You can adjust the increment value

                    var counterElement = document.getElementById('teacher');
                    ...
                    var counterInterval = setInterval(updateCounter, 100); // You can adjust the interval value
                });
            </script>
    ...
    <section>
        <div class="sect-05-about-us">
            <h1 data-aos="fade-down">Support By</h1>
            <div class="card-sect-05-about-us" id="slider">
                <?php
                $hitung = "SELECT COUNT(*) AS total FROM user WHERE role='Teacher'";
                $result = mysqli_query($koneksi, $hitung);
                ...
                <div class="card-tim" data-aos="none">
                    <img src="assets/sponsor/iegmarket.png" alt="" width="254" height="255">
                    <p>Iegmarket</p>
                </div>
                <div class="card-tim" data-aos="none">
                    <img src="assets/sponsor/iegpedia.png" alt="" width="254" height="255">
                    <p>Iegpedia</p>
                </div>
                <div class="card-tim" data-aos="none">
                    <img src="assets/sponsor/iegcodeofficial.png" alt="" width="254" height="255">
