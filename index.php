...
<body>
    ...
    <section>
        <div class="section-01" data-aos="zoom-out-down" data-aos-duration="2000">
            <div class="item-sect-01">
                ...
                <a href="<?= $homepage['src_btn_1'] ?>"><button class="btn-01"><?= $homepage['btn_1'] ?></button></a>
                <a href="<?= $homepage['src_btn_2'] ?>"><button class="btn-02"><?= $homepage['btn_2'] ?></button></a>
            </div>
            <style>
                .img-sect-01 img {
                    position: relative;
    ...
    <section>
        ...
        <img src="./assets/ba.png" alt="" width="580" height="auto" class="img-sect-02" style="display: block; margin-left: auto; margin-right: 10px;">
            <div class="text-sect-02">
                <h2 class="txt-02"><?= $homepage['title_2_1'] ?></h2>
                <div class="sub-txt-1">
                    <img src="assets/svg/ieg.png" alt="" width="55">
                ...
                <a href="<?= $homepage['src_btn_2_1'] ?>"><button class="btn-sect-01"><?= $homepage['btn_2_1'] ?></button></a>
            </div>
        </div>
    </section>
                        ...
                        <div class="sub-item-sect-04" data-aos="fade-down" data-aos-duration="3000">
                            ...
                            ?>
                                <div class="box-sect-04">
                                    <i class="<?= $typecourse['icon'] ?>" style="color: #17b8c2; margin-bottom: 5px"></i>
    ...
    <section>
        <div class="sect-05" data-aos="fade-down" data-aos-easing="ease-out-cubic" data-aos-duration="2000">
            ...
            <a href="<?= $homepage['btntarget_cta'] ?>"><button class="btn-sect-05"><?= $homepage['btn_cta'] ?></button></a>
        </div>
    </section>
    <!-------------------------------   SECTION-05 CLOSE   --------------------------------------->
                ...
                ?>
                    <div data-aos="fade-right" data-aos-duration="1000">
                        <div class="card-kursus">
                            <img src="show-image-course.php?id=<?php echo $data['id'] ?>" alt="" width="325" height="170">
                            <h2><?= $data['title'] ?></h2>
                        ...
                        <a href="https://www.iegcodestore.my.id/">
                    ...
                    <div class="box-container">
                        ...
                        ?>
                            <div class="box">
                                ...
                                <img src="./assets/me.png" alt="" width="300" height="380">
                                </div>
                            </div>
                        <?php
                        }
                ...
                <div class="testimoni">
                    <div data-aos="flip-left" data-aos-duration="3000">
                        ...
                        <div class="card-testimoni">
                            ...
                            <p>“ The course is interesting, <br>
                                and easy to understand. “<br>
                                Thank you to the author for sharing <br>
                                this very useful knowledge. ”</p>
                        </div>
                    </div>
                    <div data-aos="flip-right" data-aos-duration="3000">
                        ...
                        <div class="card-testimoni">
                            <h3>Pierre</h3>
                            <img src="assets/svg/star.svg" alt="">
                            <p>“ very satisfying and helpful <br>
                                in learning more about computer networks <br>
                                and can be useful for me to develop further <br>
                                in the world of computer networks ”</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="testimoni">
                    <div data-aos="flip-left" data-aos-duration="3000">
                        ...
                        <div class="card-testimoni">
                            <h3>Luna</h3>
                            <img src="assets/svg/star.svg" alt="">
                            <p>“ Short but powerful tutorial, the teacher's <br>
                                delivery method is very easy to understand, <br>
                                very useful and helpful in the work environment  <br>
                                and especially for the community. ”</p>
                        </div>
                    </div>
                    <div data-aos="flip-right" data-aos-duration="3000">
                        ...
                        <div class="card-testimoni">
                            <h3>Angelina</h3>
                            <img src="assets/svg/star.svg" alt="">
                            <p>“ very suitable because the trainer, <br>
                                not only explains but also provides <br>
                                an overview so that the material<br>
                                good learning is quickly understood. ”</p>
                        </div>
                    </div>
                </div>
            </div>
